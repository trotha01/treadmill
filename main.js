...
var _user$project$Item$randItem = function (items) {
	var _p1 = {
		ctor: '_Tuple2',
		_0: _user$project$Zipper$current(items),
		_1: A2(
			_elm_lang$core$Basics_ops['++'],
			_user$project$Zipper$before(items),
			_user$project$Zipper$after(items))
	};
...
var _user$project$Item$viewItem = F3(
	function (clickMsg, touchMsg, item) {
		...
		return A2(
			...
			A2(
				_elm_lang$core$Basics_ops['++'],
				_mdgriffith$elm_style_animation$Animation$render(img.style),
				{
					ctor: '::',
...
var _user$project$Item$updateImgAnimation = F2(
	function (animMsg, img) {
		var _p3 = A2(_mdgriffith$elm_style_animation$Animation_Messenger$update, animMsg, img.style);
		var style = _p3._0;
		var cmd = _p3._1;
		return {
			ctor: '_Tuple2',
...
var _user$project$Item$updateItemAnimation = F2(
	function (animMsg, item) {
		var _p4 = A2(
			_user$project$Item$updateImgAnimation,
			animMsg,
			_user$project$Zipper$current(item.imgs));
		var newImg = _p4._0;
		var cmd = _p4._1;
		var newImgs = A2(
						...
						_1: {
							...
							_0: A2(
									...
									{duration: _elm_lang$core$Time$second * 4, ease: _elm_community$easing_functions$Ease$linear}),
								{
									...
									_0: _mdgriffith$elm_style_animation$Animation$left(
										_mdgriffith$elm_style_animation$Animation$px(
											_elm_lang$core$Basics$toFloat(end))),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
...
var _user$project$Item$initItem = F3(
	function (word, imgFocus, imgSrcs) {
		...
		return {word: word, imgs: initedImgs};
	});
...
var _user$project$Item$Model = F2(
	function (a, b) {
		return {word: a, imgs: b};
	});
...
var _user$project$Treadmill$imgStyles = function (imgs) {
...
var _user$project$Treadmill$itemStyles = function (items) {
	return _elm_lang$core$List$concat(
		A2(
			_elm_lang$core$List$map,
			function (_p1) {
				return _user$project$Treadmill$imgStyles(
					function (_) {
						return _.imgs;
					}(
		...
		var idsItemsCmds = A2(
			...
			function (_p5) {
				...
				return {
					ctor: '_Tuple2',
					_0: _p6._0,
					_1: A2(_user$project$Item$updateItemAnimation, msg, _p6._1)
				};
			},
			belt.items);
		var _p7 = _elm_lang$core$List$unzip(idsItemsCmds);
		var ids = _p7._0;
		var itemCmds = _p7._1;
		var _p8 = _elm_lang$core$List$unzip(itemCmds);
		var items = _p8._0;
		var cmds = _p8._1;
		var newItems = A2(_user$project$Treadmill$zip, ids, items);
		return {
			ctor: '_Tuple2',
			_0: _elm_lang$core$Native_Utils.update(
				belt,
...
var _user$project$Treadmill$update = F2(
	function (msg, belt) {
		var _p11 = msg;
		return A2(_user$project$Treadmill$animate, _p11._0, belt);
	});
...
var _user$project$Treadmill$Animate = function (a) {
...
var _user$project$Treadmill$subscription = F2(
	function (msg, belt) {
		return A2(
			...
			function (_p12) {
				return msg(
					_user$project$Treadmill$Animate(_p12));
			},
			_user$project$Treadmill$itemStyles(belt.items));
	});
			...
			case 'Done':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							treadmill: A2(_user$project$Treadmill$removeItem, _p0._0, model.treadmill)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
